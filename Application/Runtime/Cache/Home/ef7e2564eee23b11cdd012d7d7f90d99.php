...
<body>
	<div class="container-fluid">
		...
		<div class="col-md-10 add" style="margin-top: 20px;">
			<form class="add-form" method="post" action="/homeworks/index.php/Home/Types/adds.html">
				<div class="col-md-6 add">

					<div class="input-group">
						<input type="text" name="name" class="form-control" id="inputType" placeholder="题目类型">
