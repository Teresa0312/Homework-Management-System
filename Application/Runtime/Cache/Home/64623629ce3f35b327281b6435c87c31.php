...
<body>
	<div class="container-fluid">
		<div class="table-responsive">
			<a href=<?php echo U( 'Types/adds');?> ><button type="button" class="btn btn-info back" id="add">添加题目类型</button></a>
			<table class="table table-hover table-striped">
				...
				<?php if(is_array($data)): foreach($data as $key=>$val): ?><tr id="t<?php echo ($val["id"]); ?>">
						...
						<td>
							<a href=<?php echo U( 'Types/updates?id='.$val[ 'id']);?> ><button class="btn btn-primary">修改</button></a>
