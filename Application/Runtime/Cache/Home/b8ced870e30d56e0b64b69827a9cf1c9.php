...
<ul class="list-group" >
    ...
    <li class="list-group-item" style="background:#F0F8FF;">
		...
		<li class="list-group-item" style="background:#F0F8FF;"><span class="span">题目内容:</span>
				<textarea id="myEditor1" name="content" class="textarea"><?php echo ($data["qcontent"]); ?></textarea>
			</li>
			<li class="list-group-item" style="background:#F0F8FF;"><span class="span">开始时间:</span><span class="cons"><?php echo ($data["qstime"]); ?></span></li>
			<li class="list-group-item" style="background:#F0F8FF;"><span class="span">结束时间:</span><span class="cons"><?php echo ($data["qetime"]); ?></span></li>
		</ul>

		<div class="col-md-12 question">
			<form method="post" action="/homeworks/index.php/Home/Passwords/updates/id/12.html">
				<div class="form-group">
					
					<textarea id="myEditor" name="content" class="textarea"><?php echo ($data["content"]); ?></textarea>

				</div>
				<button type="submit" class="btn btn-success" id="alter">修改答案</button>
			</form>
		</div>
	</div>
</body>
